...
-   Alternative: [Install Java channel
    server](Install Java channel server "wikilink")
-   Alternative: [Install node.js channel
    server](Install node.js channel server "wikilink") (out of support)
